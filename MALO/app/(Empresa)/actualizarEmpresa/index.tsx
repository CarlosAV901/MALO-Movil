...
export default function ActualizarEmpresa() {
  ...
  const [industriaA, setIndustria] = useState<string>(industria ||"");
  ...
  return (
    <ScrollView style={{ backgroundColor: '#F5F5F5', flex: 1 }}>
      <View style={styles.container}>
        ...
        <TextInput style={styles.input} value={nombreA} onChangeText={setNombre} placeholder="Nombre de la empresa" />
        ...
        <TextInput style={styles.input} value={industriaA} onChangeText={setIndustria} placeholder="Industria" />
        <Text style={styles.label}>Ubicación</Text>
        <TextInput style={styles.input} value={ubicacionA} onChangeText={setUbicacion} placeholder="Ubicación" />
