...
export default function RegisterForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await RegistroEmpresaService(nombre, industria, ubicacion, contrasena, email);
      Alert.alert("Éxito", "Registro completado. Registro completado. Revisa tu correo y confirma tu cuenta");
      ...
      Alert.alert("Error", "Hubo un problema al registrar la empresa. Inténtalo de nuevo.");
    }
  };
